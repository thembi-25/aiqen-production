...
import { getDocuments } from "@/lib/data/workforce/documents";
import type { DocumentType } from "@/lib/data/workforce/documents";
import { AiqenCard } from "@/components/ui/aiqen-card";
import { PageHeader } from "@/components/dashboard/page-header";

export const metadata: Metadata = {
  title: "Documents — AI Workforce",
};
...
export default function WorkforceDocumentsPage() {
  ...
  return (
    <div>
      <PageHeader title="Documents" description="Files generated and shared across your AI workforce." />
            ...
            <AiqenCard className="divide-y divide-border p-0">
              {documents
                ...
                .map((doc) => {
                  ...
                  return (
                    <div key={doc.id} className="flex flex-wrap items-center justify-between gap-4 px-6 py-4">
